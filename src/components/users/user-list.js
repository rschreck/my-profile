export let users = [
  {
    login: "rschreck",
    id: 44672855,
    node_id: "MDQ6VXNlcjQ0NjcyODU1",
    avatar_url: "https://avatars.githubusercontent.com/u/44672855?v=4",
    gravatar_id: "",
    url: "https://api.github.com/users/rschreck",
    html_url: "https://github.com/rschreck",
    followers_url: "https://api.github.com/users/rschreck/followers",
    following_url:
      "https://api.github.com/users/rschreck/following{/other_user}",
    gists_url: "https://api.github.com/users/rschreck/gists{/gist_id}",
    starred_url: "https://api.github.com/users/rschreck/starred{/owner}{/repo}",
    subscriptions_url: "https://api.github.com/users/rschreck/subscriptions",
    organizations_url: "https://api.github.com/users/rschreck/orgs",
    repos_url: "https://api.github.com/users/rschreck/repos",
    events_url: "https://api.github.com/users/rschreck/events{/privacy}",
    received_events_url:
      "https://api.github.com/users/rschreck/received_events",
    type: "User",
    site_admin: false,
  },
  {
